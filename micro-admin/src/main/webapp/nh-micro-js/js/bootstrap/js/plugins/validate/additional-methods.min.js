...
jQuery.validator.addMethod("card", function(value, element) {
    var tel = /^\d{6}(18|19|20)?\d{2}(0[1-9]|1[012])(0[1-9]|[12]\d|3[01])\d{3}(\d|[xX])$/;
    return this.optional(element) || (tel.test(value));
}, "请正确填写您的证件号码");

// 护照号码验证
jQuery.validator.addMethod("hzcard", function(value, element) {
    var tel = /^1[45][0-9]{7}|([P|p|S|s]\d{7})|([S|s|G|g]\d{8})|([Gg|Tt|Ss|Ll|Qq|Dd|Aa|Ff]\d{8})|([H|h|M|m]\d{8，10})$/;
    return this.optional(element) || (tel.test(value));
}, "请正确填写您的证件号码");

// 军官证号码验证
jQuery.validator.addMethod("jgcard", function(value, element) {
    var tel =  /[\u4e00-\u9fa5](字第){1}(\d{4,8})(号?)$/;
    return this.optional(element) || (tel.test(value));
}, "请正确填写您的证件号码");

//自定义validate验证输入的数字小数点位数不能大于两位
jQuery.validator.addMethod("minNumber",function(value, element){/([0-9]+\.[0-9]{2})[0-9]*/;
    var returnVal = true;
    inputZ=value;
