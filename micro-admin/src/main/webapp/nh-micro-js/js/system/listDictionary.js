$(function(){
	...
	user.initColumn = function () {
	    var columns = [
	            ...
	            {name : 'dict_id',index : 'dict_id',width : 90},
	            {name : 'dict_name',index : 'dict_name',width : 100},
	            {label: '详情', name: '',index: 'oper', width: 100, align: 'center', sortable: false,
	            	formatter:function (cellvalue, options, rowObject) {
	                var d = "<a class='btn btn-primary btn-xs' href='javascript:void(0)' onclick='javascript:detail(\""+rowObject.dict_id+"\")'>编辑子项</a>";
	            	    return d;
	              }
	           }
	        ]
	...
	// 接口地址
	user.url = {
		searchUrl : '/micromvc/uc/dictList/getInfoList4Page',	// 查询地址
		deleteUrl : '/micromvc/uc/dictList/delInfo', 			// 删除地址
		createUrl : '/micromvc/uc/dictList/createInfo', 		// 创建地址
		updateUrl : '/micromvc/uc/dictList/updateInfo', 		// 更新地址
		detailUrl : '/micromvc/uc/dictItem/toList?dict_id='		// 详情地址
	}
	...
	doSerch = function () {
		var dict_id = $("#s_dict_id").val();
	    var dict_name = $("#s_dict_name").val();
	    table_list.jqGrid('setGridParam', {
	        url: user.url.searchUrl,
	        postData: {'dict_id': dict_id,'dict_name':dict_name},
	        page: 1
	    }).trigger("reloadGrid");
	}
		...
		swal({ 
	        ...
	        if (rowData && rowData.id) {
	        	$.ajax({
	                ...
	                data: {id:rowData.id, dict_id:rowData.dict_id},
	                dataType: "json",
