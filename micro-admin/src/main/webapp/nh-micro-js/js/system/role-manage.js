$(function(){
	...
	user.initColumn = function () {
	    var columns = [
	            ...
	            {name : 'role_type',index : 'role_type',width : 100},
	            {label: '详情', name: '',index: 'oper', width: 100, align: 'center', sortable: false,
	            	formatter:function (cellvalue, options, rowObject) {
	                var d = "<a class='btn btn-primary btn-xs' href='javascript:void(0)' onclick='javascript:detail(\""+rowObject.role_id+"\")'>编辑权限</a>";
	            	    return d;
	              }
	           }
	        ]
	...
	user.initNames = function () {
	    var names = ['id','角色id', '角色名称','角色类型', '操作'];
	    return names;
	}
	...
	// 接口地址
	user.url = {
		searchUrl : '/micromvc/uc/roleList/getInfoList4Page',	// 查询地址
		deleteUrl : '/micromvc/uc/roleList/delInfo', 			// 删除地址
		createUrl : '/micromvc/uc/roleList/createInfo', 		// 创建地址
		updateUrl : '/micromvc/uc/roleList/updateInfo', 		// 更新地址
		detailUrl : '/micropage/nh-micro-jsp/system/rolePermission.jsp?role_id='		// 编辑权限地址
	}
