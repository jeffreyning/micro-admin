...
<head>
	...
	<!-- 自定义js -->
	<script src="<%=path%>/nh-micro-js/js/system/listDictItemsInfo.js"></script>
</head>
<body class="gray-bg">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="s_item_id" placeholder="">
                                            <input type="hidden" id="dict_id" name="dict_id" value="${dict_id}">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="s_item_name" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <a id="delete" data-toggle="modal" class="btn btn-warning"><i class="fa fa-times"></i>删除</a>
                                        <a id="return" data-toggle="modal" class="btn btn-primary" href="javascript:void(0)" onclick="javascript:history.go(-1);"><i class="fa fa-mail-reply"></i>返回</a>
                                    </div>
                                </div>
                            </div>
                        </div>
	                            ...
	                            <form class="form-horizontal m-t" id="editForm">
	                              <input type="hidden" id="id" name="id"  />
	                                <div class="form-group">
	                                    <label class="col-sm-4 control-label">字典项类型：</label>
	                                    <div class="col-sm-6">
	                                        <input name="dict_id" value="${dict_id}" class="form-control" readonly="readonly">
	                                    </div>
	                                </div>
	                                <div class="form-group">
	                                    <label class="col-sm-4 control-label">子项标识：</label>
	                                    <div class="col-sm-6">
	                                        <input id="item_id" name="item_id" class="form-control" type="text"
	                                               aria-required="true" aria-invalid="true" class="error">
	                                    </div>
	                                </div>
	                                <div class="form-group">
	                                    <label class="col-sm-4 control-label">子项名称：</label>
	                                    <div class="col-sm-6">
