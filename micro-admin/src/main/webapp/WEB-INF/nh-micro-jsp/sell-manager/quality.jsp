...
<form class="form-horizontal" role="form" id="create">
    <input type="hidden" name="id" value="${obj.id}" id="business_id">
...
<c:if test="${obj.partner==1}">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <label class="control-label">人名币： ${obj.rent_amount}元/月</label>
                </div>
        ...
        <div class="panel-body">
            ...
            <c:forEach items="${fileList}" var="f">
                <div class="form-group">
                    ...
                    <label  class="col-sm-2 control-label" style="text-align:left">附件名称：${f.file_name}</label>
    ...
    <%@ include file="include_quality.jsp" %>
    <div class="form-group" align="center">
        <input type="button" class="btn btn-danger" value="关闭" onclick="window.history.go(-1)" name="button">
        <input type="button" class="btn btn-primary" value="确定" onclick="qualitySubmit()" name="button">
    </div>
